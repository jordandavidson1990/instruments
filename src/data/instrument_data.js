...
// };
//
// Data.prototype.publishDataDetail = function(instrumentIndex){
//   const selectedFamily = this.data[instrumentIndex];
//   PubSub.publish('Data:selected-data-ready', selectedFamily)
// };
console.log('hlo');
module.exports = data;
